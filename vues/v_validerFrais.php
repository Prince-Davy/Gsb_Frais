...
<div class="corpsForm"> 
   ...
   <table class="listeLegere">
      ...
      <?php if ($ok = FALSE) { ?>
         ...
         <table>
            <i>
               <tr> Aucun frais hors forfait pour ce mois </tr>
            </i>
         </table>
         ...
         foreach ($lesFraisHorsForfait as $unFraisHorsForfait) {
            ...
            <tr>
               ...
               <?php if ((substr($libelle, 0, 6) !== "REFUSE") && ($lesInfosFicheFrais['idEtat'] === 'CR')) { ?>
                  <td><a href="index.php?uc=validerFrais&action=supprimerFrais&idFrais=<?php echo $id; ?>&idVis=<?php echo $idUtilisateur; ?>&moisAng=<?php echo $moisAng; ?>" 
...
<form method="POST"  action="index.php?uc=validerFrais&action=validerJustificatif"> 
   <div class="corpsForm">
      <input type="hidden" name="idVis" value="<?php echo $idUtilisateur; ?>" />
      <input type="hidden" name="leMois" value="<?php echo $moisAng; ?>" />
      <p>
         ...
         <h1><?php
            ...
            espace(2)
            ?> Nombre de justificatifs fournis : <?php
